const CACHE = "gentle-pause-pwa-balanced-final-logic-v1-2";
const SHELL = ["./", "./index.html", "./manifest.webmanifest", "./icon-192.png", "./icon-512.png", "./icon-180.png", "./icon-1024.png"];
